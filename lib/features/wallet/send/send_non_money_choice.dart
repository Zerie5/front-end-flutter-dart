...
class LulSendNonMoneyChoiceScreen extends StatefulWidget {
  const LulSendNonMoneyChoiceScreen({super.key});

  @override
  State<LulSendNonMoneyChoiceScreen> createState() =>
      _LulSendNonMoneyChoiceScreenState();
}

class _LulSendNonMoneyChoiceScreenState
    extends State<LulSendNonMoneyChoiceScreen>
  ...
  Future<void> _checkLoginAndRefreshData() async {
    ...
    if (token != null) {
      print('SendNonMoneyScreen: User is logged in, refreshing currency data');
      await _refreshCurrencyData();
    } else {
      print(
          'SendNonMoneyScreen: User is not logged in, skipping currency refresh');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Obx(() => Text(
              _languageController.getText('amount'),
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) {
    ...
    if (state == AppLifecycleState.resumed) {
      print(
          'SendNonMoneyScreen: App resumed, but not refreshing currency data (will only refresh when screen is opened)');
    }
  }
